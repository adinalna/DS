...
public class GenericQueue<E>{
    ...
    //Constructor for the genric queue class
    ...
    public void changeOrder(int k){
        GenericQueue<E>tempQ= new GenericQueue<>(capacity);
        //Remove heads of original Q until before k into temp queue
        for(int i=0;i<k-1;i++){
            QueueNode<E>newNode=new QueueNode<>(head.element);
            tail.next=newNode;
            tail=newNode;
            head=head.next;
        }
